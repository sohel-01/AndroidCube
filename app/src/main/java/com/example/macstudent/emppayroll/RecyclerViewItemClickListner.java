...
public class RecyclerViewItemClickListner implements RecyclerView.OnItemTouchListener{
    ...
    public RecyclerViewItemClickListner(Context context, final RecyclerView recyclerView, OnItemClickListener listener) {
        ...
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public void onLongPress(MotionEvent e) {
                ...
                if (child != null && mItemClickListener != null) {
                    mItemClickListener.onLongItemClick(child, recyclerView.getChildAdapterPosition(child));
                }
            }
        });
    }
